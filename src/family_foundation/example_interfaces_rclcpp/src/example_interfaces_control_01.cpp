...
public:
    ExampleInterfacesControl(std::string name) : Node(name) 
    {
        ...
        /*创建move_robot客户端*/
        client_ = this->create_client<public_msgs::srv::MoveRobot>("move_robot");
        /*订阅机器人状态话题,Qos:10 意思是：*/
        robot_status_subscribe_ = this->create_subscription<public_msgs::msg::RobotStatus>("robot_status", 10, std::bind(&ExampleInterfacesControl::robot_status_callback_, this, std::placeholders::_1));
    }
...
private:
    // 声明客户端
    rclcpp::Client<public_msgs::srv::MoveRobot>::SharedPtr client_;
    rclcpp::Subscription<public_msgs::msg::RobotStatus>::SharedPtr robot_status_subscribe_;

    /* 机器人移动结果回调函数 */
    void result_callback_(rclcpp::Client<public_msgs::srv::MoveRobot>::SharedFuture result_future) 
    {
    ...
    * @param msg 
    */
    void robot_status_callback_(const public_msgs::msg::RobotStatus::SharedPtr msg)
    {
